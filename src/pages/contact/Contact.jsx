...
const Contact = () => {
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto mt-10 ml-100 bg-white p-6 rounded-lg shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="email" placeholder='CURRENT PASSWORD' className="mt-1 block w-[848px] border border-gray-300 rounded-md shadow-sm p-2" readOnly />
              </div>
              <div>
          ...
          <div>
            <div className="space-y-4">
              ...
              <div>
                <input type="password" placeholder='Confirm new password' className="mt-33 block w-full border border-gray-300 rounded-md shadow-sm p-2" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-end space-x-4">
          ...
          <button className="px-4 py-2 bg-[#DB4444] text-white rounded-md cursor-pointer">Save Changes</button>
        </div>
      </div>
    </div>
  );

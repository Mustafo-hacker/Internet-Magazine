...
const RightSide = () => {
    return (
        <div>  <div className="flex flex-wrap ml-[50px] mt-[140px]">
            {products.map((el) => (
                <div
                    key={el.id}
            ...
            <p className='ml-[390px] mt-[50px] cursor-pointer'><span className='text-[white] bg-[#DB4444] p-[15px_45px] rounded-[4px]'>More Products</span></p>

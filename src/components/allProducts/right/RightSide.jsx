        ...
        <div>
                    ...
                    >
                        <div className="relative flex justify-center w-[360px] h-[240px] items-center bg-gray-100 p-4 rounded-lg">
                            ...
                            <button
                                ...
                                className="absolute cursor-pointer bottom-0 bg-[black] text-white  px-35 max-[638px]:px-35 py-2 rounded-md max-[638px]:opacity-100 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                Add to cart
                            </button>
                        </div>
            ...
            <Link to="/home">
                <p className='ml-[390px] mt-[50px] cursor-pointer max-[638px]:ml-[100px]'>
                    <span className='text-[white] bg-[#DB4444] p-[15px_45px] rounded-[4px] hover:bg-red-500'>
                        More Products
                    </span>
                </p>
            </Link>

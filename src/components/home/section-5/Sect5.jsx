    ...
    return (
        <div className='mt-[50px]'>
            <div className='flex'>
                ...
                <h1 className='text-[#DB4444] font-[600] pt-[50px] pl-[15px]'>Our Products</h1>
            </div>
            <div className="flex">
                <h1 className='pl-[140px] font-[500] text-[37px] pt-[25px]'>Explore Our Products</h1>
            </div>
            ...
            <Link to="/allProduct">
                <p className='ml-[650px] mt-[30px] cursor-pointer'><span className='text-[white] bg-[#DB4444] p-[15px_45px] rounded-[4px]'>View All Products</span></p>
            </Link>
        </div>
    )
}

    ...
    return (
        <div>
            <div className='flex'>
                ...
                <h1 className='text-[#DB4444] font-[600] pt-[50px] pl-[15px]'>This Month</h1>
            </div>
            <div className="flex">
                <h1 className='pl-[140px] font-[500] text-[37px] pt-[25px]'>Best Selling Products</h1>
                <p className='ml-[755px] mt-[45px] cursor-pointer'><span className='text-[white] bg-[#DB4444] p-[15px_45px] rounded-[4px]'>View All</span></p>
            </div>
            ...
            <img className='flex m-auto mt-26' src={baner2} alt="" />
        </div>
    )
}

...
const Sect1 = () => {
    ...
    return (
        <div className='relative mt-[100px] max-[638px]:mt-[50px]'>
            <div>
            ...
            <div className='absolute left-1/6 transform-translate-x-1/2 ml-[120px] top-5 w-[64%] max-[1024px]:w-[80%] max-[768px]:w-full max-[638px]:static max-[638px]:w-full max-[638px]:ml-[0] max-[638px]:mt-[20px]'>
                <Swiper
